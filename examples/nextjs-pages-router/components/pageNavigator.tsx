...
import { darkThemes, lightThemes } from "../data/themes";
    ...
    <div className="page-navigator">
      ...
      <nav>
        ...
        <select value={exampleType} onChange={e => setExampleType(e.target.value)}>
          ...
          <option value="forced-color-scheme">Force Color Scheme on page</option>
        </select>
        ...
        {exampleType && exampleOption ? <Link href={`/${exampleType}/${exampleOption}`}>Go</Link> : null}
      </nav>
      <br />
      <nav>
        <b>Static Pages:</b>
